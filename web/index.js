...
function IdeaView(db3) {
  return {
    view({ attrs: { id: id2 } }) {
      ...
      return import_mithril3.default("div.idea-view", import_mithril3.default(CE, { selector: "h1.title", value: idea.name, onchange: (name) => db3.ideas.upsert(Object.assign(idea, { name })) }), import_mithril3.default("p.description", idea.description), import_mithril3.default("p.proposer", idea.proposer ?? ""), import_mithril3.default("div.scenarios", db3.scenarios.get({ idea: id2 }).map((s2) => import_mithril3.default(ScenarioSummary, { scenario: s2, update: (s3) => db3.scenarios.upsert(s3) })), import_mithril3.default("div.scenario-summary.new", { onclick: () => db3.scenarios.add(new Scenario("value = price * reach", "New Scenario", idea.id)) }, import_mithril3.default("span", "+ Add Scenario"))));
    }
  };
}
function ScenarioView(db3) {
  return {
    view({ attrs: { id: id2 } }) {
      ...
      return import_mithril3.default("div.scenario", import_mithril3.default("h1.name[contenteditable=true]", import_mithril3.default.trust(scenario.name)));
    }
  };
}
var CE = {
...
var OpportunitySummary = {
  view({ attrs: { opportunity, update } }) {
    return import_mithril3.default("div.opportunity", import_mithril3.default("div.outputs", import_mithril3.default("div.stats", import_mithril3.default(LabeledNumber, { number: mean_default(opportunity.samples), label: "Mean" }), import_mithril3.default(LabeledNumber, { postunit: "%", number: 100 * opportunity.quantile(mean_default(opportunity.samples)), label: "MeanQ" }), import_mithril3.default(LabeledNumber, { number: median_default(opportunity.samples), label: "Median" }), import_mithril3.default(LabeledNumber, { postunit: "%", number: 100 * filter_default((x2) => x2 < 0, opportunity.samples).length / opportunity.samples.length, label: "Loss Chance" })), import_mithril3.default(CDFPlot(opportunity.quantileF())), import_mithril3.default(TornadoPlot(opportunity.sensitivity()))), import_mithril3.default("div.inputs", import_mithril3.default(FormulaText, { formula: opportunity.model.formulaString(), update: (s2) => {
      opportunity.model = new Model(s2);
    } }), import_mithril3.default("div.spts", opportunity.model.inputs.map((x2) => {
      let input = opportunity.inputs[x2];
      return import_mithril3.default(isCertain(input) ? FixedInputView : SPTInputView, {
        name: x2,
        input: input.estimate,
        update: (values2) => {
          input.estimate = values2;
          update(input);
        }
      });
    }))));
...
var SPTInputView = {
  view({ attrs: { name, input, update, simple } }) {
    return import_mithril3.default("div.spt-input", import_mithril3.default("h4", name), import_mithril3.default("div.input-stack", (simple ? ["low", "med", "high"] : ["min", "low", "med", "high", "max"]).map((q) => import_mithril3.default("input", {
      type: "number",
      value: input[q],
...
var FixedInputView = {
  view: ({ attrs: { name, input, update, simple } }) => import_mithril3.default("div.spt-input", import_mithril3.default("h4", name), import_mithril3.default("div.input-stack", import_mithril3.default("input", {
    type: "number",
    value: input,
